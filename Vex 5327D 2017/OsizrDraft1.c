...
#pragma config(Motor,  port2,           baseLeftFront, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           baseRightFront, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           baseLeftBack,  tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           baseRightBack, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           RightRightLift, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           RightLeftLift, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           LeftRightLift, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           LeftLeftLift,  tmotorVex393HighSpeed_MC29, openLoop)
...
#define PID_MOTOR_1_INDEX   RightRightLift
#define PID_MOTOR_2_INDEX   RightLeftLift
#define PID_MOTOR_3_INDEX   LeftRightLift
#define PID_MOTOR_4_INDEX   LeftLeftLift
