...
#pragma config(Motor,  port2,           lefttopdrive,  tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port3,           righttopdrive, tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port4,           leftbotdrive,  tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port5,           rightbotdrive, tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port6,           rightlift,     tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           leftlift,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           mogolift,      tmotorVex393HighSpeed_MC29, openLoop)
...
task autonomous()
{
	motor[mogolift]=50;
	wait10Msec(175);
	motor[leftbotdrive]=motor[rightbotdrive]=motor[righttopdrive]=motor[lefttopdrive]=127;
	wait10Msec(200);
	motor[mogolift]=-50;
	wait10Msec(25);
	motor[leftbotdrive]=motor[rightbotdrive]=motor[righttopdrive]=motor[lefttopdrive]=-127;
	wait10Msec(150);
	motor[rightbotdrive]=motor[righttopdrive]=-127;
	motor[leftbotdrive]=motor[lefttopdrive]=127;
	wait10Msec(250);
	motor[mogolift]=50;
	wait10Msec(175);
}
...
task slewBase ()
{
  ...
  while (true)
  {
  	//Index 1 & 3 are right base motors
		motorReq[ 3 ] = motorReq[ 5 ] = motorReq[ 2 ] = motorReq[ 4 ] = vexRT[Ch2];
...
#define PID_MOTOR_1_INDEX   mogolift
...
task slewLift()
{
	while (true)
	{
		if (vexRT[Btn5U] == 1)
		{
			motorReq[ 8 ] = motor[ PID_MOTOR_1_INDEX ];
		}
